...
//Declaring Regex patterns
    //UC1
    public static final String firstName = "^[A-Z]{1}[a-z]{3,}$";
    //UC2
    public static final String lastName= "^[A-Z]{1}[a-z]{3,}$";
    //UC3
    ...
    //UC4
    public static final String mobileNoFormat = "^[9,1]{2}?[0-9]{10}$";
    //UC5-Rule1
    public static final String passwordRule1= "^[a-zA-Z0-9]{8,}$";
          //    String regex = "^[A-Za-z]{8,}$";
    //UC6-Rule2
    public static final String passwordRule2 = "^[A-Z]{1,}[a-z]{7,}$";
       //    String passwordPatternSecondRule="^[A-Z][a-zA-Z0-9]{8,}";
    //UC7-Rule3
    public static final String getPasswordRule3 = "^[A-Z]{1,}[0-9]{1,}[a-z]{6,}$";
    ...
    public static void validateMobileNumber() {
        ...
        Pattern pattern = Pattern.compile(mobileNoFormat);
    ...
    public static void validatePasswordRule3() {
        ...
        Scanner sc = new Scanner(System.in);
        String passWord = sc.next();
        Pattern pattern = Pattern.compile(getPasswordRule3);
        Matcher matcher = pattern.matcher(passWord);
        boolean retrurn = matcher.matches();
        if (retrurn) {
            System.out.println("Password is Valid");
